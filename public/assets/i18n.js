...
const TRANSLATIONS = {
  en: {
    ...
    role_outdoor: "Outdoor / Construction Worker",
    role_fisherman: "Fisherman / Coastal Worker",
    role_elderly: "Senior Citizen / Health Sensitive",
    role_delivery: "Delivery Partner / Rider",
    role_tourist: "Traveler / Event Organizer",
  ...
  hi: {
    ...
    role_student: "छात्र / अभिभावक",
    role_outdoor: "बाहरी श्रमिक / कामगार",
    role_fisherman: "मछुआरा / तटीय निवासी",
    role_elderly: "वरिष्ठ नागरिक / स्वास्थ्य संवेदनशील",
    role_delivery: "डिलीवरी पार्टनर / राइडर",
    role_tourist: "पर्यटक / इवेंट आयोजक",
  ...
  gu: {
    ...
    role_student: "વિદ્યાર્થી / વાલી",
    role_outdoor: "બાંધકામ / મજૂર",
    role_fisherman: "માછીમાર / દરિયાકાંઠાના રહેવાસી",
    role_elderly: "વરિષ્ઠ નાગરિક / આરોગ્ય સંવેદનશીલ",
    role_delivery: "ડિલિવરી પાર્ટનર / રાઇડર",
    role_tourist: "પ્રવાસી / ઇવેન્ટ આયોજક",
